        ...
        for event in events:
            if isinstance(event, MessageEvent):
                ...
                #包車選項流程    
                    ...
                    b = len(models.charteredOption.objects.all)
                    c = len(models.chartered_order.objects.all)
                    d = len(models.questProfile.objects.all)
                    e = len(models.car_order.objects.all)
